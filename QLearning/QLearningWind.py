...
class Environment:
    ...
    def step(self, action):
        # Evolve agent state
        y = self.state[0] + self.action_coords[action][0]
        x = self.state[1] + self.action_coords[action][1]
        ...
        #if(state_next[1] == 3 or state_next[1] == 4 or state_next[1] == 5 or state_next[1] == 8):
            #if(state_next[0] != 0):
                #state_next[0] = state_next[0] - 1
        
        #if(state_next[1] == 6 or state_next[1] == 7):
            #if(state_next[0] > 1):
                #state_next[0] = state_next[0] - 2
           # elif(state_next[0] == 1):
                #state_next[0] = state_next[0] - 1
        ...
        done = (state_next[0] == 3) and (state_next[1] == 7) 
        # Update state
    ...
    def _build_rewards(self):
        ...
        R[4, 7, self.action_dict["down"]] = r_goal  
        R[6, 7, self.action_dict["up"]] = r_goal
        R[5, 6, self.action_dict["right"]] = r_goal
        R[5, 8, self.action_dict["left"]] = r_goal
